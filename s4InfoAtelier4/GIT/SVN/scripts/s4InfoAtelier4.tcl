...
#
# Generated by Vivado on Wed Feb 28 20:25:25 -0500 2024
...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [list \
   ...
   "$origin_dir/../vhdSources/archive_project_summary.txt" \
  ...
  set paths [list \
   ...
   [file normalize "$origin_dir/../ipRepo/atelier4_testPatternGen2_0"] \
...
set orig_proj_dir "[file normalize "$origin_dir/../work/s4InfoAtelier4"]"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../ipRepo/mycolorRegister_1.0"] [file normalize "$origin_dir/../ipRepo/atelier4"] [file normalize "$origin_dir/../ipRepo/pixelDataToVideoStream_1.0"] [file normalize "$origin_dir/../ipRepo/rgb2dvi"] [file normalize "$origin_dir/../ipRepo/tmds_v1_0"] [file normalize "$origin_dir/../ipRepo/atelier4_testPatternGen2_0"] [file normalize "$origin_dir/../vivado-library-2020.1"]" $obj
...
set files [list \
 ...
 [file normalize "${origin_dir}/../vhdSources/atelier4.vhd"]\
 [file normalize "${origin_dir}/../vhdSources/archive_project_summary.txt" ]\
]
...
#set file "${origin_dir}/../vhdSources/atelier4.vhd"
#set file [file normalize $file]
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
#set_property -name "registered_with_manager" -value "1" -objects $file_obj

#set file "${origin_dir}/../vhdSources/atelier4.bd"
#set file [file normalize $file]
#set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
#set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
#set_property -name "top" -value "testPatternGen2" -objects $obj
...
# ###################### #
source $origin_dir/../scripts/block.tcl
